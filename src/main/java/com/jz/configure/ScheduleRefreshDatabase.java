...
public class ScheduleRefreshDatabase {
    ...
    public void scheduleUpdateCronTrigger() throws SchedulerException {
        ...
        List<SchedulerConfig> schedulerConfigs= schedulerConfigService.getSchedulerConfig();
        if(schedulerConfigs==null||schedulerConfigs.size()<1){
            return;
        }
        String searchCron = schedulerConfigService.getSchedulerConfig().get(0).getCron();// 从数据库查询出来的
